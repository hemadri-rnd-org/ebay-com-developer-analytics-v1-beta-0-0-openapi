# Analytics API MCP Server

This MCP (Model Content Protocol) server provides access to Analytics API API functionality through HTTP, HTTPS, and STDIO transport modes.
